    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            ...
            <div class="card card-small mb-3">
                <div class="card-body">
                    <form class="add-new-post" action="{{route('adminproducts.update', ['adminproduct' => $product->id])}}" method="post">
                        @method('PUT')
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div id="editor-container" class="add-new-post__editor mb-1">
                            <div class="card-header border-bottom"><h6 class="m-0">Edit Categories</h6></div>
                            <div class="container">
                                <div class="container-fluid">
                                    <div class="form-group">
                                        <div class="row" style="margin-top: 10px">
                                            <label class="col-md-3">Title</label>
                                            <div class="col-md-6"><input type="text" name="title" class="form-control" value="{{$product->title}}"></div>
                                    ...
                                    <div class="form-group">
                                        <div class="row" style="margin-top: 10px">
                                            <label class="col-md-3">Title</label>
                                            <div class="col-md-6"><input type="text" name="amount" class="form-control" value="{{$product->amount}}"></div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
