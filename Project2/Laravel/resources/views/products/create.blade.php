    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            ...
            <div class="card card-small mb-3">
                <div class="card-body">
                    <form class="add-new-post" action="{{route('adminproducts.store')}}" method="post">
                        <input type="hidden" name="_token" value="{{csrf_token()}}">
                        <div id="editor-container" class="add-new-post__editor mb-1">
                            <div class="card-header border-bottom"><h6 class="m-0">Add Products</h6></div>
                            <div class="container">
                                <div class="container-fluid">
                                    ...
                                    <div class="form-group">
                                        <div class="row" style="margin-top: 10px">
                                            ...
                                            <div class="col-md-6"><input type="number" name="amount" class="form-control"></div>
                                            <div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
